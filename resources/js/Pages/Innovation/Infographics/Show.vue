		...
		<section class="w-full min-h-screen px-80 pb-10">
			...
			<div class="flex justify-between items-center mt-10 gap-8">
				...
				<img class="w-1/2 h-[600px] object-cover"
					:src=" '/storage/' + ( infographic.image ? infographic.image.path : '/images/magazines-optimized.jpg' ) "
					:alt=" ( infographic.image ? infographic.image.name : 'default-infographic-image' ) ">
			</div>
		</section>
	</div>
</template>
