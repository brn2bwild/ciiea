...
<template>
	...
	<section class="px-4 sm:px-12 pb-16">
		<div class="w-full sm:h-96 mt-44 sm:mt-12 flex flex-wrap justify-stretch rounded-lg overflow-hidden">
			<div class="w-full h-full sm:w-1/2 bg-rose-900 text-neutral-50 p-8 flex flex-col justify-center">
				...
				<p class="sm:text-lg">
					Número telefónico: 932 322 3381
				</p>
				<div class="w-full flex justify-center items-center gap-8 mt-10">
