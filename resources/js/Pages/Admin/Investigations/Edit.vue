...
<template>
    ...
    <h1 class="pl-8 text-3xl font-bold">Editar Investigación</h1>
    <div class="w-full p-8">
        <section class="flex w-full justify-between rounded bg-white p-8">
            <form @submit.prevent="handleUpdateInvestigation" class="w-3/4">
                <div>
                    ...
                    <TextInput
                        ...
                        v-model="investigationForm.title"
                        required
                        autofocus
                        autocomplete="investigation_title"
                    />
                    <InputError
                        class="mt-2"
                        :message="investigationForm.errors.title"
                    />
                </div>
                <div class="mt-4">
                    ...
                    <TextInput
                        ...
                        type="text"
                        class="mt-1 block w-full"
                        v-model="investigationForm.authors"
                        required
                        autofocus
                        autocomplete="investigation_authors"
                    />
                    <InputError
                        class="mt-2"
                        :message="investigationForm.errors.authors"
                    />
                </div>
                <div class="mt-4">
                    <InputLabel
                    ...
                    <TextInput
                        ...
                        type="text"
                        class="mt-1 block w-full"
                        v-model="investigationForm.short_description"
                        required
                        autofocus
                    ...
                    <InputError
                        class="mt-2"
                        :message="investigationForm.errors.short_description"
                    />
                </div>
                <div class="mt-4">
                    <InputLabel
                    ...
                    <TextInput
                        ...
                        type="date"
                        class="mt-1 block w-full"
                        v-model="investigationForm.publicated_at"
                        required
                    />
                    <InputError
                        class="mt-2"
                        :message="investigationForm.errors.publicated_at"
                    />
                </div>
                <div class="mt-4 flex items-center gap-4">
                    <PrimaryButton :disabled="investigationForm.processing"
                    ...
                    >
                        <p
                            v-if="investigationForm.recentlySuccessful"
            ...
            <FileInput
                ...
                :resource-id="investigation.id"
                :upload-file-route="route('admin.investigations.upload-file')"
                :delete-file-route="route('admin.investigations.delete-file')"
                class="w-1/4"
            />
        </section>
    </div>
