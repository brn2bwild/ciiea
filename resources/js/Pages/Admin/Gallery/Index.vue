...
<template>
    ...
    <div class="w-full p-8">
        ...
        <Pagination :links="props.events.links" class="mt-8 flex justify-center" />
    </div>
            ...
            <form @submit.prevent="handleCreateEvent()">
                <div class="mt-4">
                    ...
                    <TextInput
                        ...
                        v-model="eventCreateForm.name"
                        required
                        autocomplete="name"
                    />
                    <InputError
                        class="mt-2"
                        :message="eventCreateForm.errors.name"
                    />
                </div>
                <div class="mt-4">
                    ...
                    <InputError
                        class="mt-2"
                        :message="eventCreateForm.errors.date"
                    />
                </div>
                <div class="w-full flex justify-end mt-8 gap-4">
                    <PrimaryButton
                        :class="{ 'opacity-25': eventCreateForm.processing }"
        ...
        <div class="p-4">
            <div class="w-full flex flex-col justify-center items-center">
                ...
                <div class="w-full flex justify-end mt-4 gap-4">
                    <DangerButton @click="handleDeleteEvent()"
