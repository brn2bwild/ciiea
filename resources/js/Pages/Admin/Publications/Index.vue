...
const handleDeletePublication = () => {
	publicationDeleteForm.delete(route('admin.historical-publications.destroy'), {
			...
			<form @submit.prevent=" handleCreatePublication()">
				...
				<div class="mt-4">
					...
					<TextInput id="publicated_at" type="date" class="mt-1 block w-full"
						v-model=" publicationCreateForm.publicated_at " required autocomplete="publicated_at" />
					<InputError class="mt-2" :message=" publicationCreateForm.errors.publicated_at " />
				</div>
				<div class="w-full flex justify-end mt-8 gap-4">
					<PrimaryButton :class=" { 'opacity-25': publicationCreateForm.processing } "
