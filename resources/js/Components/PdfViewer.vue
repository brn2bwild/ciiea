	...
	<div class="relative rounded overflow-hidden flex justify-center items-center">
		<div class="absolute z-10 w-full h-full flex justify-between rounded">
			<button @click="page = page > 1 ? page - 1 : page"
				class="h-full bg-neutral-900 bg-opacity-10 hover:bg-opacity-40 transition duration-200 text-neutral-50 p-2">
		...
		<a :href="props.url" class="absolute bottom-2 right-10 z-10 bg-neutral-900 bg-opacity-10 hover:bg-opacity-40 px-4 py-3 rounded-lg text-neutral-50">Descargar</a>
