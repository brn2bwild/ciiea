...
<template>
    <footer class="relative w-full bg-white px-14">
        <div class="flex w-full justify-center py-10">
            <h1 class="text-xl font-medium text-neutral-600">
                Centro de Investigación e Innovación para la Enseñanza y el
                Aprendizaje
            </h1>
        </div>
        <hr class="h-0.5 border-t-0 bg-neutral-300" />
        <div class="flex items-center justify-between py-8">
            ...
            <div class="flex w-2/3 items-center justify-end gap-8">
                <a
                ...
                >
                    ...
                    />
                    <span
                        class="text-center text-xs text-neutral-600 group-hover:text-neutral-800"
                    >
                        Carretera a las Grutas S/N, Colonia Eureka y Belen, C.P.
                        86800 Teapa, Tabasco
                    </span>
                </a>
                <p class="w-52 text-center text-xs text-neutral-600">
                    Horario de atención<br />
                    8:00 a.m. - 3:00 p.m. lunes a viernes
                </p>
                <p class="w-52 text-center text-xs text-neutral-600">
                    Número telefónico<br />932 322 3381
                </p>
            </div>
        </div>
        <div class="flex justify-end gap-4 px-10 py-6">
            ...
            <span class="text-sm text-neutral-600"> Derechos reservados </span>
        </div>
    </footer>
</template>
